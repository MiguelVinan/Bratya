...
gulp.task('gsap', function (){
  return gulp.src([paths.gsap + 'ScrollMagic.min.js', paths.gsap + 'TweenMax.min.js', paths.gsap + 'TimelineMax.min.js', paths.gsap + 'animation.gsap.min.js', paths.gsap + 'ScrollToPlugin.min.js']) /*paths.gsap + 'debug.addIndicators.min.js'*/
